...
function kopa_shortcode_contact_form($atts, $content = null) {
    ...
    $out .= '<label class="required" for="contact_name">' . __('Имя (обязательно):', 'kopa-nictitate-toolkit') . '</label>';
    $out .= '<input class="valid" type="text" name="name" id="contact_name" value="">';
    $out .= '</p>';

    $out .= '<p class="input-block clearfix">';
    $out .= '<label class="required" for="contact_email">' . __('Почта(обязательно):', 'kopa-nictitate-toolkit') . '</label>';
    $out .= '<input type="email" class="valid" name="email" id="contact_email" value="">';
    $out .= '</p>';

    $out .= '<p class="input-block clearfix">';
    $out .= '<label class="required" for="contact_url">' . __('Сайт:', 'kopa-nictitate-toolkit') . '</label>';
    $out .= '<input type="url" class="valid" name="url" id="contact_url" value="">';
    $out .= '</p>';

    $out .= '<p class="textarea-block">';
    $out .= '<label class="required" for="contact_message">' . __('Сообщение (обязательно):', 'kopa-nictitate-toolkit') . '</label>';
    $out .= '<textarea id="contact_message" name="message"></textarea>';
    $out .= '</p>';

    $out .= '<p class="comment-button clearfix">';
    $out .= '<input type="submit" id="submit-contact" value="' . __('Отправить', 'kopa-nictitate-toolkit') . '">';
    $out .= '</p>';
    ...
    if ($atts['address'] || $atts['phone'] || $atts['email']) {
        ...
        $out.= '<h2 class="contact-title">' . __('Контактная информация', 'kopa-nictitate-toolkit') . '<span></span></h2>';
        $out.= '<div class="acc-wrapper">
                    <div class="accordion-title">
                        <h3><a href="#">' . __('Как с нами связаться?', 'kopa-nictitate-toolkit') . '</a></h3>
                        <span>+</span>
                    </div>
